...
const NavBar = () => {
	...
	return (
		<div className="flex px-12 p-4 text-sm font-bold justify-between items-center">
			...
			<div className="hidden lg:inline">
				<ul className="flex justify-center hover:cursor-pointer animate__animated animate__fadeIn">
			...
			<div className="lg:hidden">
				<button
					className="inline-flex items-center py-2 px-4 rounded-md bg-black/5 text-sm font-medium shadow-sm hover:bg-black/10"
					onClick={handleNav}
				>
					Menu
				</button>
