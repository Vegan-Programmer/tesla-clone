		...
		<div className="flex px-12 p-4 text-sm font-bold justify-between items-center">
			...
			<div className="hidden lg:inline">
				<ul className="flex justify-center hover:cursor-pointer">
					...
					<li className="py-1 px-3 hover:rounded hover:bg-black/5">
						<a href="https://www.tesla.com">Menu</a>
					</li>
				</ul>
			</div>
			<div className="lg:hidden">
				<button className="inline-flex items-center py-2 px-4 rounded-md bg-black/5 text-sm font-medium shadow-sm hover:bg-black/10">
					Menu
				</button>
			</div>
		</div>
